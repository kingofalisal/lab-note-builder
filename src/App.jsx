...
const DEFAULT_SNIPPETS = [
  ...
  { id:"vitd_normal", group:"Vitamin D", trigger:"Vitamin D normal", text:"Your vitamin D level is in the normal range. Continue your current supplement if you are taking one.", clinicianActions:[], staffActions:[] },
  { id:"vitd_low", group:"Vitamin D", trigger:"Vitamin D low", text:"Your vitamin D level is lower than normal. I recommend starting a vitamin D supplement. You can purchase this over the counter — a dose of 2,000 IU daily is a reasonable starting point for most adults. We will recheck your level in 3–4 months.", clinicianActions:["Order vitamin D recheck in 3–4 months"], staffActions:[] },
  { id:"vitd_very_low", group:"Vitamin D", trigger:"Vitamin D very low", text:"Your vitamin D level is significantly low and will need a higher dose to correct. I am sending in a prescription for a higher-dose vitamin D supplement. Please take it once weekly for 8 weeks as directed. We should recheck your level in about 3 months to see if it is improving.", clinicianActions:["Prescribe high-dose vitamin D (e.g. ergocalciferol 50,000 IU weekly x8 weeks)","Order vitamin D recheck in 3–4 months"], staffActions:[] },
  { id:"vitd_on_supplement", group:"Vitamin D", trigger:"Vitamin D on supplement", text:"Your vitamin D level looks good on your current supplement — keep taking it.", clinicianActions:[], staffActions:[] },
  ...
  { id:"lpa_normal", group:"Lipoprotein(a)", trigger:"Lp(a) normal", text:"Your lipoprotein(a) is in the normal range, indicating no increased cardiovascular risk from this marker. This test is recommended once for most adults and does not need to be repeated.", clinicianActions:[], staffActions:[] },
  { id:"lpa_elevated", group:"Lipoprotein(a)", trigger:"Lp(a) elevated", text:"Your lipoprotein(a) level is elevated. Lipoprotein(a) is a type of cholesterol particle that is largely determined by genetics and can increase the risk of heart attack and stroke. Unlike LDL cholesterol, it does not respond well to diet or standard medications. While we cannot easily lower your Lp(a) directly, we can make sure all your other cardiovascular risk factors are well controlled. We can discuss this further at your next visit, or sooner if you'd like to schedule a visit.", clinicianActions:[], staffActions:[] },
  { id:"sti_negative", group:"STI", trigger:"STI screen negative", text:"Your STI screening results are all negative. This includes urine tests for chlamydia and gonorrhea and blood tests for syphilis and HIV.", clinicianActions:[], staffActions:[] },
  { id:"hcv_negative", group:"HCV", trigger:"HCV negative", text:"Your hepatitis C antibody test is negative, meaning no hepatitis C infection has been detected. We test all adults once and more frequently if you are at ongoing risk for the disease.", clinicianActions:[], staffActions:[] },
  { id:"hbv_immune", group:"HBV", trigger:"HBsAg neg and HBV immune", text:"Your hepatitis B tests show that you are immune to hepatitis B and do not have an active hepatitis B infection.", clinicianActions:[], staffActions:[] },
  { id:"hbv_not_immune", group:"HBV", trigger:"HBsAg neg but NOT HBV immune", text:"Your hepatitis B test shows that you do not have hepatitis B infection but are not immune. We should start your hepatitis B vaccination series to give you lifelong immunity and protection.", clinicianActions:["Order/administer hepatitis B vaccine series"], staffActions:[] },
  { id:"b12_normal", group:"Vitamin B12", trigger:"B12 normal", text:"Your vitamin B12 level is in the normal range. If you are taking a supplement, continue it. Otherwise, no need to start taking extra B12.", clinicianActions:[], staffActions:[] },
  { id:"b12_borderline", group:"Vitamin B12", trigger:"B12 borderline (200–400)", text:"Your vitamin B12 level is in the borderline range. I'd like you to start taking a vitamin B12 supplement — 1,000 mcg daily by mouth. We can recheck your B12 level next time we do blood tests.", clinicianActions:[], staffActions:[] },
  { id:"b12_low", group:"Vitamin B12", trigger:"B12 low", text:"Your vitamin B12 level is lower than normal. B12 is important for nerve function and red blood cell production. Low levels can sometimes cause fatigue, tingling, or memory issues. I recommend starting a B12 supplement — 1,000 mcg daily by mouth is a good dose for most adults. We will recheck in 3 months.", clinicianActions:["Order B12 recheck in 3 months"], staffActions:[] },
  { id:"psa_normal_screening", group:"PSA", trigger:"PSA screening – normal", text:"Your PSA test for prostate cancer screening is normal. If you'd like to continue screening, we should repeat the test in 1–4 years depending on your PSA level and risk factors.", clinicianActions:[], staffActions:[] },
  { id:"psa_mildly_elevated", group:"PSA", trigger:"PSA screening – mildly elevated", text:"Your PSA test for prostate cancer screening is mildly elevated. This does NOT mean you have prostate cancer, but we do need to recheck your level in about a month to see if it remains high. If it is still elevated, I'll refer you to a urologist to discuss whether you need additional testing.", clinicianActions:["Order PSA recheck in 1 month"], staffActions:[] },
  { id:"psa_quite_elevated", group:"PSA", trigger:"PSA screening – quite elevated", text:"Your PSA test for prostate cancer screening is high and requires further evaluation. I am referring you to a urologist to discuss the best next steps. Please expect to hear about your referral within 1 week. Contact our office if you do not.", clinicianActions:["Refer to urology for elevated PSA"], staffActions:["Ensure urology referral is sent and patient is contacted within 1 week."] },
  { id:"psa_normal_prior_ca", group:"PSA", trigger:"PSA normal – prior prostate cancer", text:"Your PSA level is low or undetectable, which is reassuring and does not show signs of recurrence of your prostate cancer. We should repeat this test in one year.", clinicianActions:[], staffActions:[] },
  { id:"psa_elevated_prior_ca", group:"PSA", trigger:"PSA elevated – prior prostate cancer", text:"Your PSA level is elevated. I'd like you to schedule a follow-up with your urologist to discuss the best next steps. If you don't have a current urologist, let me know and I can send a referral.", clinicianActions:["Refer to urology for elevated PSA — prior prostate cancer history"], staffActions:["Assist patient with urology referral or contact existing urologist's office."] },
